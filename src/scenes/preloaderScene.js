...
export default class PreloaderScene extends Phaser.Scene {
  ...
  preload () {
    ...
    this.load.image('blueButton1', 'assets/ui/bluebutton02.png');
    this.load.image('blueButton2', 'assets/ui/bluebutton03.png');
    ...
    this.load.audio('menuOver', ['assets/music/menu-over.mp3']);
